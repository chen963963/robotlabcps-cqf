...
def find_correspondences(prompt, image_path1: str, image_path2: str, num_pairs: int = 10, load_size: int = 224, layer: int = 9,
    ...
    image1_batch, image1_pil = extractor.preprocess(prompt, image_path1, load_size)
    ...
    image2_batch, image2_pil = extractor.preprocess(prompt, image_path2, load_size)
