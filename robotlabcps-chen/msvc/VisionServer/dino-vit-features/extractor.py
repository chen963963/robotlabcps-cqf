...
import sys
sys.path.append('./Seg/florence_sam')
...
class ViTExtractor:
    ...
    @staticmethod
    def add_mask(input_image, prompt):
    ...
    def preprocess(self, prompt, image_path: Union[str, Path],
        ...
        if isinstance(image_path, np.ndarray):
            pil_image = Image.fromarray(image_path).convert('RGB')
        else:
            # 如果 image_path 是文件路径
        ...
        pil_image = self.add_mask(pil_image, prompt)
