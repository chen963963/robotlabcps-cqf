...
"    global jog_speed_vector_dt = p[0, 0, 0, 0, 0, 0]" + NEW_LINE  + 
"    global jog_start_pose = p[0, 0, 0, 0, 0, 0]" + NEW_LINE  + 
"    global jog_thrd = 0" + NEW_LINE  + 
"    global jog_dt = 0.002" + NEW_LINE  + 
"    global jog_state = 0 # 0 - inactive, 1 - new setpoint, 2 - jogging, 3 - stopping (decelerating)" + NEW_LINE  + 
"    " + NEW_LINE  + 
...
"    end" + NEW_LINE  + 
"" + NEW_LINE  + 
"    global async_finished = -2" + NEW_LINE  + 
"" + NEW_LINE  + 
...
"        target_pose = p[0, 0, 0, 0, 0, 0]" + NEW_LINE  + 
"      end" + NEW_LINE  + 
"" + NEW_LINE  + 
"      while (True):" + NEW_LINE  + 
"        enter_critical" + NEW_LINE  + 
...
"            pose_via = pose_from_input_float_registers(0)" + NEW_LINE  + 
"            pose_to = pose_from_input_float_registers(6)" + NEW_LINE  + 
"            velocity = read_input_float_reg(12)" + NEW_LINE  + 
"            acceleration = read_input_float_reg(13)" + NEW_LINE  + 
"            blend = read_input_float_reg(14)" + NEW_LINE  + 
"            movec_mode = read_input_integer_reg(1)" + NEW_LINE  + 
...
"$V54        write_output_float_reg(0, step_time)" + NEW_LINE  + 
...
"$V53        pose_to_output_float_registers(0, target_waypoint)" + NEW_LINE  + 
...
"$V36        tcp_offset = get_tcp_offset()" + NEW_LINE  + 
"$V36        textmsg(tcp_offset)" + NEW_LINE  + 
"$V36        pose_to_output_float_registers(0, tcp_offset)" + NEW_LINE  + 
...
"                jog_thrd = run jog_thread()" + NEW_LINE  + 
"              end" + NEW_LINE  + 
"              exit_critical" + NEW_LINE  + 
...
"    # HEADER_END" + NEW_LINE  + 
"" + NEW_LINE  + 
"    # RTDE_CONTROL_LOOP_BEGIN" + NEW_LINE  + 
"" + NEW_LINE  + 
"    #" + NEW_LINE  + 
"    # RTDE Control script - Main loop" + NEW_LINE  + 
"    #" + NEW_LINE  + 
"" + NEW_LINE  + 
"    textmsg("+QUOTATION+"RTDE Control Script Loaded (16.02.2021-14:53)"+QUOTATION+")" + NEW_LINE  + 
"" + NEW_LINE  + 
...
"    # RTDE_CONTROL_LOOP_END" + NEW_LINE  + 
"";