...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::GLSL()
{
	...
	if (!inited)
	{
		static const char* const keywords[] = {
			...
			"_Noreturn", "_Static_assert", "_Thread_local", "vec2", "vec3", "vec4", "mat2", "mat3", "mat4", "sampler2D", "uniform", "in", "out", "layout"
		};
		for (auto& k : keywords)
			langDef.mKeywords.insert(k);
		...
		static const char* const identifiers[] = {
			...
			"tolower", "toupper", "smoothstep", "length", "min", "max", "clamp", "mix", "texture", "main", "normalize", "dot"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
