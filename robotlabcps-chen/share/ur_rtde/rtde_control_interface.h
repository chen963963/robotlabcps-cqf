...
class RTDEControlInterface
{
 public:
  ...
  RTDE_EXPORT bool sendCustomScript(const std::string &script, int execution_timeout_seconds);
  RTDE_EXPORT bool sendCustomScriptFile(const std::string &script, int execution_timeout_seconds);
